...
- There are several ways to run the AI-K8S-MCP Labs.
...
=== "🐳 Docker (Recommended)"
    ...
    docker run -it --pull=always -p 3000:3000 ghcr.io/nirgeier/ai-k8s-mcp
    ```
...
=== "![](assets/images/killercoda-icon.png){:. width-24px} Killercoda"
    ...
    * Learn in your browser without any local installation
    ...
    🌐 <a href="https://killercoda.com/codewizard/scenario/AIK8SMCP" target="_blank">**Launch on Killercoda**</a>
...
=== "📜 From Source"
    ...
    git clone https://github.com/nirgeier/AI-K8S-MCP
...
=== "![](assets/images/gcp.png){:.width-24px} Using Google Cloud Shell"
    ...
    - Click on the `Open in Google Cloud Shell` button below:
      ...
      [![Open in Cloud Shell](https://gstatic.com/cloudssh/images/open-btn.svg)](https://console.cloud.google.com/cloudshell/editor?cloudshell_git_repo=https://github.com/nirgeier/AI-K8S-MCP)
