...
class MCPClient:
    ...
    async def sample_llm(self, prompt: str, model: str = "codestral:latest", max_tokens: int = 500) -> Dict[str, Any]:
    ...
    async def chat_with_llm(self, message: str, model: str = "codestral:latest", system_prompt: str = "") -> str:
    ...
    async def generate_with_llm(self, prompt: str, model: str = "codestral:latest", max_tokens: int = 500) -> str:
